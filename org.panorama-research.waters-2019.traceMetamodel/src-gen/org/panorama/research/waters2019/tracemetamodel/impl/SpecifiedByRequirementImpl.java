...
import org.panorama.research.waters2019.tracemetamodel.SpecifiedByRequirement;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.panorama.research.waters2019.tracemetamodel.impl.SpecifiedByRequirementImpl#getSource <em>Source</em>}</li>
 *   <li>{@link org.panorama.research.waters2019.tracemetamodel.impl.SpecifiedByRequirementImpl#getTarget <em>Target</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SpecifiedByRequirementImpl extends DirectedTraceLinkImpl implements SpecifiedByRequirement {
	...
	protected EClass eStaticClass() {
		return TracemetamodelPackage.Literals.SPECIFIED_BY_REQUIREMENT;
	}
	...
	public EList<EObject> getTarget() {
		if (target == null) {
			target = new EObjectResolvingEList<EObject>(EObject.class, this, TracemetamodelPackage.SPECIFIED_BY_REQUIREMENT__TARGET);
		}
		return target;
	}
