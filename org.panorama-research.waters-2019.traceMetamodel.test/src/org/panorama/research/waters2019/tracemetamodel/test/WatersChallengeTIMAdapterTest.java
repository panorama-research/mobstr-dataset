package org.panorama.research.waters2019.tracemetamodel.test;
 ...
 *
 */
public class WatersChallengeTIMAdapterTest {
	...
	public void testCreateRelatedToTrace() throws CoreException, IOException {
		...
		createTraceForCurrentSelectionOfType(TracemetamodelPackage.eINSTANCE.getRelatedTo());
	...
	public void testCreateImplementsComponentTrace() throws CoreException, IOException {
		...
		createTraceForCurrentSelectionOfType(TracemetamodelPackage.eINSTANCE.getImplementsComponent());
